...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "c369d3b3eacba59be180b0100f5542ad.jpg";
	...
	var _user$project$Main$update = F2(
		function (msg, model) {
			...
			if (_p0.ctor === 'SelectStack') {
				...
				var _p1 = _p0._0;
				var newStack = _user$project$Main$randomHipStack(_p1);
				return _elm_lang$core$Native_Utils.eq(model.selectedStack, newStack) ? {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(
						_elm_lang$core$Random$generate,
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							stackSelected: true,
							selectedStack: _user$project$Main$randomHipStack(_p1),
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('This app is built with love by '),
							A2(
							_elm_lang$html$Html$a,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$href('http://twitter.com/jwo')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('JWo')
								])),
							_elm_lang$html$Html$text(' from Sugar Land, TX with Elm and Webpack, deployed to GitHub Pages  '),
							A2(
							_elm_lang$html$Html$a,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$href('https://github.com/jwo/hipstack.me')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
